...
handle_t My_int_handler;


static const RPC_CLIENT_INTERFACE My_int___RpcClientInterface =
    {
...
RPC_IF_HANDLE My_int_v1_0_c_ifspec = (RPC_IF_HANDLE)& My_int___RpcClientInterface;

extern const MIDL_STUB_DESC My_int_StubDesc;

static RPC_BINDING_HANDLE My_int__MIDL_AutoBindHandle;
    ...
    /* [string][in] */ unsigned char *pass)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&My_int_StubDesc,
                  (PFORMAT_STRING) &My_int__MIDL_ProcFormatString.Format[0],
                  name,
                  pass);
    ...
    /* [string][in] */ unsigned char *serv_path)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&My_int_StubDesc,
                  (PFORMAT_STRING) &My_int__MIDL_ProcFormatString.Format[44],
                  sz_buff,
                  buff,
                  serv_path);
    ...
    /* [in] */ int offset)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&My_int_StubDesc,
                  (PFORMAT_STRING) &My_int__MIDL_ProcFormatString.Format[88],
                  sz_buff,
                  send_buff,
                  serv_path,
                  offset);
    ...
    /* [string][in] */ unsigned char *serv_path)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&My_int_StubDesc,
                  (PFORMAT_STRING) &My_int__MIDL_ProcFormatString.Format[144],
                  serv_path);
    return ( int  )_RetVal.Simple;
    ...
    /* [in] */ int *dwPublicLen)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&My_int_StubDesc,
                  (PFORMAT_STRING) &My_int__MIDL_ProcFormatString.Format[182],
                  pbPublicKey,
                  dwPublicLen);
    ...
    /* [out][in] */ unsigned char scom_buf[ 1024 ])
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&My_int_StubDesc,
                  (PFORMAT_STRING) &My_int__MIDL_ProcFormatString.Format[220],
                  scom_buf);
...
static const MIDL_STUB_DESC My_int_StubDesc = 
    {
    (void *)& My_int___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &My_int_handler,
    0,
